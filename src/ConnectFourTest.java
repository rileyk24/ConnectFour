...
public class ConnectFourTest {
	...
	////////// PRIVATE METHODS //////////
	/**
	 * prints the data array of the window for debugging.
	 */
	...
	/**
	 * false: gameOver() == false (empty board)
	...
	/**
	 * true: each individual column is full
	 * equal: a full board of non-matching ints returns 0 ==> a draw
	 */
	@Test
	...
	/**
	 * Plays a horizontal win for player 1
	 * true: gameOver() == true when player 1 wins
	 * equal: getWinner() returns 1
	 * equal: getWinningPositions() returns correct winning positions
	 */
	@Test
	public void testP1HorizontalWinner()	{
		...
		assertEquals("player 1 horizontal winner correct", 1, tester.getWinner());	//is the correct winner noted
	...
	/**
	 * Plays a horizontal win for player 2
	 * true: gameOver() == true when P2 wins
	 * equal: getWinner() returns 2
	 * equal: getWinningPositions() returns winning positions
	 */
	@Test
	public void testP2HorizontalWinner()	{
		p2HorizWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 2 horizontal win working correctly", 2, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		tempPos = new Position(5, startPos);
		for(int c = startPos; c < startPos+4; c++)	{
			tempPos.setCol(c);
	...
	/**
	 * Plays a vertical win for player 1
	 * true: gameOver() == true when player 1 wins
	 * equal: getWinner() returns 1
	 * equal: getWinningPositions() returns correct winning positions
	 */
	...
	public void testP1VerticalWinner()	{
		p1VertWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 1 vertical win working correctly", 1, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
	...
	/**
	 * Plays a vertical win for player 2
	 * true: gameOver() == true when player 2 wins
	 * equal: getWinner() returns 2
	 * equal: getWinningPositions() returns correct winning positions
	 */
	@Test
	public void testP2VerticalWinner()	{
		p2VertWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 2 vertical win working correctly", 2, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
		tempPos = new Position(rowStart, startPos);
		for(int i = 0; i < winningPositions.length; i++){
	...
	/**
	 * Plays a forward slash win for player 1
	 * true: gameOver() == true when player 1 wins
	 * equal: getWinner() returns 1
	 * equal: getWinningPositions() returns correct winning positions
	 */
	...
	public void testP1ForwardSlashWinner()	{
		p1FwdSlashWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 1 forward slash win working correctly", 1, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
		tempPos = new Position(rowStart, startPos);
		for(int i = 0; i < winningPositions.length; i++){
	...
	/**
	 * Plays a forward slash win for player 2
	 * true: gameOver() == true when player 2 wins
	 * equal: getWinner() returns 2
	 * equal: getWinningPositions() returns correct winning positions
	 */
	...
	public void testP2ForwardSlashWinner()	{
		p2FwdSlashWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 2 forward slash win working correctly", 2, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
		tempPos = new Position(rowStart, startPos);
		for(int i = 0; i < winningPositions.length; i++){
	...
	/**
	 * Plays a backslash win for player 1
	 * true: gameOver() == true when player 1 wins
	 * equal: getWinner() returns 1
	 * equal: getWinningPositions() returns correct winning positions
	 */
	...
	public void testP1BackSlashWinner()	{
		p1BackSlashWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 1 backslash win working correctly", 1, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
		tempPos = new Position(rowStart, startPos);
		for(int i = 0; i < winningPositions.length; i++){
	...
	/**
	 * Plays a backslash win for player 2
	 * true: gameOver() == true when player 2 wins
	 * equal: getWinner() returns 2
	 * equal: getWinningPositions() returns correct winning positions
	 */
	...
	public void testP2BackSlashWinner()	{
		p2BackSlashWin();
		assertTrue("Testing if the game is over", tester.gameOver());
		assertEquals("player 2 back slash win working correctly", 2, tester.getWinner());
		winningPositions = tester.getWinningPositions();
		int rowStart = 5;
		tempPos = new Position(rowStart, startPos);
		for(int i = 0; i < winningPositions.length; i++){
